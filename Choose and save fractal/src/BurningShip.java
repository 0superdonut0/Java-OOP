...
//Этот класс является подклассом FractalGenerator. Он используется для вычисления Фрактала Горящего корабля
public class BurningShip extends FractalGenerator
{
    ...
    /**
     ...
     фрактала. Этот метод
     должен установить начальный диапазон в (-2 - 2.5i) - (2 + 2.5i). Т.е. значения x
     и y будут равны -2 и -2.5 соответственно, а ширина и высота будут равны 4.
     */
    ...
    */
    public int numIterations(double x, double y)
    {
        ...
        double zimaginary = 0;
        /**
         Уравнение имеет вид zn = (|Re(z_n-1)| + i|Im(z_n-1)|)^2 + c. , где значения представляют собой комплексные числа, представленные
         ...
         Другими словами, вы берете абсолютное значение каждого компонента zn-1 на каждой
         итерации.
        */
