...
public class FractalExplorer
{
    ...
    */
    public void createAndShowGUI()
    {
        ...
        */
        myframe.setTitle("Choose and save fractal");
        Toolkit toolkit = Toolkit.getDefaultToolkit();
        Dimension dimension = toolkit.getScreenSize();
        myframe.setBounds(dimension.width/2 - 300,dimension.height/2 - 300, 580, 580);
        myframe.pack();
    ...
    */
    ...
    {
        FractalExplorer displayExplorer = new FractalExplorer(580);
