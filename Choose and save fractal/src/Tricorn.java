...
//Этот класс является подклассом FractalGenerator. Он используется для вычисления Фрактал трикорн
public class Tricorn extends FractalGenerator
{
    ...
    фрактала. Этот метод
    должен установить начальный диапазон в (-2 - 2i) - (2 + 2i). Т.е. значения x
    и y будут равны -2 и -2 соответственно, а ширина и высота будут равны 4.
    */
